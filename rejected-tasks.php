...
// Fetch rejected tasks only
$tasks_query = "SELECT * FROM tasks WHERE status = 'rejected' ORDER BY created_at DESC LIMIT $limit OFFSET $offset";
$tasks_result = mysqli_query($conn, $tasks_query);

// Total rejected tasks count
$countQuery = "SELECT COUNT(*) as total FROM tasks WHERE status = 'rejected'";
...
<head>
    ...
    <title>Rejected Tasks - Admin Dashboard</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="rejected-tasks.php" class="active"><i class="fas fa-times-circle"></i> Rejected Tasks</a></li>
        </ul>
    </div>
    ...
    <div class="main-content">
        ...
        <div class="welcome-header">
            <h2><i class="fas fa-times-circle me-2"></i>Rejected Tasks</h2>
            <p>View all rejected tasks in the system</p>
        </div>

        <!-- Tasks Table -->
        <div class="table-section">
            <div class="table-header">
                <h4><i class="fas fa-clipboard-list me-2"></i>Rejected Tasks (<?php echo $totalTasks; ?>)</h4>
            </div>
                    ...
                    <nav aria-label="Tasks Pagination">
                        <ul class="pagination pagination-modern justify-content-center">
                            <li class="page-item <?php echo ($page <= 1) ? 'disabled' : ''; ?>">
                                <a class="page-link" href="<?php echo ($page > 1) ? 'rejected-tasks.php?page=' . ($page - 1) : '#'; ?>">
                            ...
                            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                                    <a class="page-link" href="rejected-tasks.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                </li>
                            <?php endfor; ?>

                            <li class="page-item <?php echo ($page >= $totalPages) ? 'disabled' : ''; ?>">
                                <a class="page-link" href="<?php echo ($page < $totalPages) ? 'rejected-tasks.php?page=' . ($page + 1) : '#'; ?>">
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    ...
                    <h3 class="fw-semibold text-dark mb-2">No Rejected Tasks</h3>
                    <p class="text-muted mb-4">No tasks have been rejected yet.</p>
                </div>
            <?php endif; ?>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-0">
                        ...
                        <p id="admin_view_description" class="border-start border-4 border-danger ps-3" style="white-space: pre-wrap;"></p>
                    </div>
                </div>
